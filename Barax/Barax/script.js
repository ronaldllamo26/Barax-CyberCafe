...
function updateStatus() {
    ...
    // Open from 8 AM to 12 AM (midnight)
    ...
    if (hours > 0) {
        totalPriceDiv.innerHTML = `
            <div style="margin-top: 20px;">
                <div style="font-size: 1rem; color: var(--text-gray); margin-bottom: 10px;">Total Amount:</div>
                <div style="font-size: 2rem; color: var(--neon-orange);">₱${total.toFixed(2)}</div>
            </div>
        `;
...
console.log('%cSearch endpoint requested!', 'color: #00ff88; font-size: 12px;');